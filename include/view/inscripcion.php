...
<body>
                    ...
                    <div class="card pmd-card">
                        <div class="pmd-tabs">
                            <ul id="tabs-cursos" class="nav nav-tabs nav-fill nav-bordered nav-justified" role="tablist">
                                <li class="nav-item tippy-tooltip-tab" data-plugin="tippy" data-tippy-placement="top" title="Formulario de inscripción a Cursos Virtuales">
                                    <a class="nav-link active" href="#formulario-inscripcion" aria-controls="home" role="tab" data-toggle="tab">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="formulario-inscripcion">
                                    <!-- Form row -->
                                ...
                                <div role="tabpanel" class="tab-pane" id="cursos-inscritos">
                                    <!-- Form row -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div id="infotable">
                                                            <table id="table-search" class="table table-striped w-100 nowrap">
                                                                <thead id="headtable">
                                                                    <tr>
    ...
    <!-- third party js -->
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/jquery.dataTables.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/dataTables.bootstrap4.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/dataTables.responsive.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/responsive.bootstrap4.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/dataTables.buttons.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/buttons.bootstrap4.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/buttons.html5.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/buttons.flash.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/buttons.print.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/dataTables.keyTable.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/datatables/dataTables.select.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/pdfmake/pdfmake.min.js"></script>
    <script src="<?php echo $CNG->wwwroot; ?>/assets/libs/pdfmake/vfs_fonts.js"></script>
    <!-- third party js ends -->
    <!-- Datatables init -->
    <script src="<?php echo $CNG->wwwroot; ?>/assets/js/pages/datatables.init.js"></script>
