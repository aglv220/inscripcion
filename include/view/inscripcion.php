    ...
    <div id="wrapper">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="cursos-inscripcion">
                                    ...
                                    <form class="parsley-form" id="frmGuardar" action="index.php" method="POST">
                                        ...
                                        <div class="row collapse" id="crdpersonal">
                                            <div class="col-md-12">
                                                <div class="card-box">
                                                    ...
                                                    <div class="div-cod-modular mb-3">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group position-relative col-md-4">
                                                                <input type="text" class="form-control" data-parsley-minlength="7" maxlength="7" id="cod_modular" name="cod_modular" 
                                                                placeholder="Digite su código modular" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p class="sub-header text-primary font-weight-bold">
                                                        Ingrese su Nº de DNI y su Fecha de Nacimiento, luego haga click en "validar", sus nombres y apellidos se incluirán automáticamente.
                                                    </p>
                                                    <div class="form-row">
                                                        <div class="form-group position-relative col-md-4">
                                        ...
                                        <div class="form-row" id="div-btn-registro">
                                            <div class="form-group position-relative col-md-6">
                                                <input class="btn btn-primary waves-effect waves-light" type="submit" id="guardar" form="frmGuardar" value="Registrarse">
                                                <!-- <span class="spinner-border spinner-border-sm mr-1" id="saving" hidden></span> -->
                                            </div>
        ...
        <footer class="footer" style="left:0px !important;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        2017 - 2022 &copy; Escuela Nacional de Salud Pública <a href="pees.minsa.gob.pe">ENSAP</a>
                    </div>
                    <div class="col-md-6">
