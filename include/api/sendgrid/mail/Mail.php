...
require_once($CNG->dirroot .'/include/api/sendgrid/mail/Personalization.php');
require_once($CNG->dirroot .'/include/api/sendgrid/mail/Content.php');
require_once($CNG->dirroot .'/include/api/sendgrid/mail/From.php');
require_once($CNG->dirroot .'/include/api/sendgrid/mail/Subject.php');
require_once($CNG->dirroot .'/include/api/sendgrid/mail/To.php');
require_once($CNG->dirroot .'/include/api/sendgrid/mail/MimeType.php');
require_once($CNG->dirroot .'/include/api/sendgrid/helper/Assert.php');
