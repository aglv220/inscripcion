                ...
                case 'guardar':
                    ...
                    if($curso == 0){
                        ...
                        if(isset($ERROR_UPLOAD)){
                            ...
                            $result = $a->saveAlumnoByCurso($dni, $fecnac, $entidad, $pliego, $ipliego, $uejecutora, $iuejecutora, $establecimiento, $iestablecimiento, $region,
                                                        $nombres, $apepat, $apemat, $apecas, $correo, $celular, $fecha, $curso, $ubigeo, $profesion, $regimenlab, $condicionlab, 
                                                        $icondicionlab, $ruc, $tipo, $file_uploaded, $cod_modular);
                        }
                    }
